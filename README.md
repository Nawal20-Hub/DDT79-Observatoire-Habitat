...
## Phase‑12 — Livrable final

Le livrable final regroupe :
- les indicateurs (CSV) dans `outputs/indicateurs/`,
- les graphiques (PNG) dans `outputs/graphiques/`,
- les rapports dans `docs/11_rapport_population.*` et `docs/12_livrable_final.md`,
- les scripts R et SQL dans `R/` et `sql/`.